...
with tab1:
    ...
    ## UNCOMMENT beloww
    response1 = requests.get(f"https://mvpdraftaaalll-uzj4hctfqa-ew.a.run.app/predict?F1={id}&F2h={gender}&F3={age}&F4={height_cm}&F5={weight_kg}&F6={waist_cm}&F7={eyesight_left}&F8={eyesight_right}&F9={hearing_left}&F10={hearing_right}&F11={systolic}&F12={relaxation}&F13={fasting_glucose}&F14={cholesterol}&F15={triglyceride}&F16={hdl}&F17={ldl}&F18={hemoglobin}&F19={urine_protein}&F20={serum_creatinine}&F21={ast}&F22={alt}&F23={gtp}&F24h={oral}&F25={dental_caries}&F26h={tartar}").json()
    #
    #response1 = requests.get(f"http://127.0.0.1:8000/predict?F1={id}&F2h={gender}&F3={age}&F4={height_cm}&F5={weight_kg}&F6={waist_cm}&F7={eyesight_left}&F8={eyesight_right}&F9={hearing_left}&F10={hearing_right}&F11={systolic}&F12={relaxation}&F13={fasting_glucose}&F14={cholesterol}&F15={triglyceride}&F16={hdl}&F17={ldl}&F18={hemoglobin}&F19={urine_protein}&F20={serum_creatinine}&F21={ast}&F22={alt}&F23={gtp}&F24h={oral}&F25={dental_caries}&F26h={tartar}").json()#.text
    #import json
    #print(response1)
    ...
    with col4:
        ...
        if uploaded_photo:
            ...
            if uploaded_photo is not None:
                ...
                uploaded_photo.seek(0)
                response = requests.post('https://mvpdraftaaalll-uzj4hctfqa-ew.a.run.app/uploadfile',files=files).json()#headers
